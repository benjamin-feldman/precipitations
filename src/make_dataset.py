...
class DatasetCreator:
    ...
    def extract_df_month(self):
        ...
        dates = [self.get_date_from_file(filename) for filename in files if filename.endswith('.npy')]
...
if __name__ == "__main__":
    ...
    parser.add_argument('-y', '--year', default=2021, type=int, required=False, help='The year of the dataset.')
    parser.add_argument('-s', '--start_month', default=1, type=int, required=False, help='The start month for which the dataset will be created.')
